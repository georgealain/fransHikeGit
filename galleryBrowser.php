          ...
          <div class="row align-items-center position-relative">
            ...
            <nav class="site-navigation text-left ml-auto " role="navigation">
              <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                ...
                <li class="active"><a href="photoGallery.php" class="nav-link">Photo Gallery</a></li>
...
<h2 align="center" class="text-cursive"><a href="photoGallery.php"> Back to events' list </a> </h2>
...
<div class="tz-gallery">
    ...
    <div class="row">
      ...
      $galleryName= urldecode( strval($_GET['gallery']) );
      $galleryPath = "photoGallery/" . $galleryName . "/";
      ...
      if ($handle = opendir($galleryPath)) {
          while (false !== ($file = readdir($handle))) {
              ...
              //$urlEncoded=
              $picturePath= strval($galleryPath . strval($file) );
              // do something with the file
      ?>

        <div class="col-sm-6 col-md-4">
            <a class="lightbox" href="<?php print $picturePath; ?>">
                <img src="<?php print $picturePath; ?>">
            </a>
        </div>
